...
export const SEVEN_DAYS_ROADMAP: DayPlan[] = [
  ...
  },
  {
    ...
    tasks: [
      ...
      { id: 'd7_t2', title: 'Descargar el Informe Integral D.U.E.R.M.E.™ en PDF', description: 'Guarda tu diagnóstico, gráficos y recomendaciones de Leo.', durationMinutes: 5, completed: false },
