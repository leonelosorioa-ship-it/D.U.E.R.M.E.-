...
export function LeadCaptureModal({ onSaveLead, defaultEmail }: LeadCaptureModalProps) {
  ...
  const handleSubmit = (e: FormEvent) => {
    e.preventDefault();
    if (!nombre.trim()) {
      setError('Por favor escribe tu nombre para que Leo pueda personalizar tu guía.');
      return;
    }
    ...
    <div className="max-w-xl mx-auto px-4 py-8 space-y-6">
      ...
      <div className="text-center space-y-2">
        ...
        <p className="text-xs sm:text-sm text-slate-300">
          Tu mentor <strong>Leo</strong> (Mentor de Vínculos y Conexión Digital) adaptará cada una de las 7 noches a tu fisiología y ritmo biológico.
        </p>
      </div>
